...
export function SectionSkeleton({ className, height = "50vh" }: { className?: string, height?: string }) {
  return (
    <section 
      className={cn("w-full px-6 py-24 sm:py-32 flex flex-col items-center justify-center", className)}
